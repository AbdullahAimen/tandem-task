...
import com.demo.networkpagination.databinding.ItemNetworkStateBinding

class LoadStateAdapter(
    private val adapter: CardsAdapter
) : LoadStateAdapter<com.demo.networkpagination.ui.adapter.LoadStateAdapter.NetworkStateItemViewHolder>() {
